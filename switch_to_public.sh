...
# Script de configuration pour accès via domaine public
# Configure l'application pour utiliser le domaine Emergent
# Auteur: GMAO Iris
# Date: 2025-01-11
...
echo "╔══════════════════════════════════════════════════════════╗"
echo "║  🌐 Configuration pour accès via domaine public         ║"
echo "║     URL: github-auth-issue-1.preview.emergentagent.com  ║"
echo "╚══════════════════════════════════════════════════════════╝"
echo ""
...
echo "  👉 https://github-auth-issue-1.preview.emergentagent.com"
echo ""
log_info "Identifiants:"
echo "  • Email: admin@gmao-iris.local"
echo "  • Mot de passe: Admin123!"
echo ""
log_warning "Note: Cette configuration fonctionne via Internet/domaine public"
log_warning "Pour accéder via Tailscale (100.105.2.113), exécutez: ./switch_to_tailscale.sh"
echo ""
