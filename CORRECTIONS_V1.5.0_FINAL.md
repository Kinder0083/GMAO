...
```env
FRONTEND_URL=https://iris-maintenance-2.preview.emergentagent.com
BACKEND_URL=https://iris-maintenance-2.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://iris-maintenance-2.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://iris-maintenance-2.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://iris-maintenance-2.preview.emergentagent.com`
...
curl https://iris-maintenance-2.preview.emergentagent.com/api/version
...
# Ouvrir : https://iris-maintenance-2.preview.emergentagent.com/login
...
curl -X GET https://iris-maintenance-2.preview.emergentagent.com/api/version \
  -H "Origin: https://iris-maintenance-2.preview.emergentagent.com"
