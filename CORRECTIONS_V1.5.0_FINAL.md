...
```env
FRONTEND_URL=https://workorder-forge.preview.emergentagent.com
BACKEND_URL=https://workorder-forge.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://workorder-forge.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://workorder-forge.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://workorder-forge.preview.emergentagent.com`
...
curl https://workorder-forge.preview.emergentagent.com/api/version
...
# Ouvrir : https://workorder-forge.preview.emergentagent.com/login
...
curl -X GET https://workorder-forge.preview.emergentagent.com/api/version \
  -H "Origin: https://workorder-forge.preview.emergentagent.com"
