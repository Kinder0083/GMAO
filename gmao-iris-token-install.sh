...
###############################################################################
# GMAO Iris v1.0 - Installation avec GitHub Token (Dépôt Privé)
# 
...
clear
echo "╔════════════════════════════════════════════════════════════════╗"
echo "║      GMAO IRIS v1.0 - Installation (Dépôt Privé GitHub)       ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
...
# Créer le script Python pour les admins
...
async def main():
    ...
    if existing:
        admin1['id'] = existing.get('id', admin1['id'])
    ...
    if existing_backup:
        admin2['id'] = existing_backup.get('id', admin2['id'])
