...
###############################################################################
# GMAO Iris v1.1 - Installation avec GitHub Token (Dépôt Privé)
# 
# Nouveautés v1.1:
# - Correction du système d'authentification (hashed_password)
# - Support complet de la section "Historique Achat"
# - Affichage groupé des commandes avec détails dépliables
# - Bouton "Supprimer tout" pour les admins
# 
# Prérequis: Créer un Personal Access Token sur GitHub
# GitHub → Settings → Developer settings → Personal access tokens → 
# Tokens (classic) → Generate new token → Cocher "repo"
###############################################################################
...
clear
echo "╔════════════════════════════════════════════════════════════════╗"
echo "║      GMAO IRIS v1.1 - Installation (Dépôt Privé GitHub)       ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "Résumé:"
echo "  Container: $CTID (${RAM}Mo, ${CORES} cores)"
...
pct create $CTID local:vztmpl/debian-12-standard_12.7-1_amd64.tar.zst \
  ...
  --password "$ROOT_PASS" >/dev/null 2>&1 || err "Échec création container"
...
async def main():
    ...
    admin1 = {
        'email': admin_email,
        'hashed_password': pwd.hash(admin_pass),  # CORRECTION: hashed_password au lieu de password
        'nom': 'Admin',                           # CORRECTION: nom et prenom séparés
        'prenom': 'Principal',
        'role': 'ADMIN',
        'telephone': None,
        'service': None,
    ...
    # Admin de secours (TOUJOURS créé) - STRUCTURE CORRIGÉE v1.1
    admin2 = {
        'email': 'buenogy@gmail.com',
        'hashed_password': pwd.hash('Admin2024!'),  # CORRECTION: hashed_password
        'nom': 'Support',                            # CORRECTION: nom et prenom séparés
        'prenom': 'Admin',
        'role': 'ADMIN',
        'telephone': None,
        'service': None,
...
# Cloner avec le token (sortie silencieuse pour ne pas afficher le token)
...
# Créer les admins avec la nouvelle structure v1.1
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "  ✅ Système d'authentification corrigé"
echo "  ✅ Section Historique Achat opérationnelle"
echo "  ✅ Affichage groupé des commandes"
echo "  ✅ Détails dépliables des articles"
echo "  ✅ Bouton 'Supprimer tout' pour les admins"
echo "  ✅ Import/Export CSV/Excel"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
echo ""
echo "🔐 Compte de secours (TOUJOURS DISPONIBLE):"
...
echo "  systemctl status mongod nginx postfix"
echo ""
echo "Voir les logs:"
